...
export default {
  ...
  methods: {
    copyCode() {
      ...
      this.copyConfig =
        "// Custom configuration, reference ./default/setting.config.js，The properties that need to be customized can be configured here\n";
      ...
      clipboard.on("success", function() {
        _this.$message.success(
          `Copy successfully, overwrite the file src/config/config.js and restart the project to take effect`
        );
        clipboard.destroy();
      });
    },
