    ...
    <a-row class="form-row">
      ...
      <a-col :xl="{span: 8, offset: 2}" :lg="{span: 10}" :md="{span: 24}" :sm="24">
        ...
        >
          ...
          >
            <a-select-option value="Huang Lili">黄丽丽</a-select-option>
            <a-select-option value="Li Dadao">Li Dadao</a-select-option>
          </a-select>
        </a-form-item>
      </a-col>
    </a-row>
      ...
      <a-col :xl="{span: 8, offset: 2}" :lg="{span: 10}" :md="{span: 24}" :sm="24">
        <a-form-item :label="$t('type')">
          ...
          >
            ...
            <a-select-option value="Periodic execution">Periodic execution</a-select-option>
          </a-select>
        </a-form-item>
      </a-col>
    </a-row>
