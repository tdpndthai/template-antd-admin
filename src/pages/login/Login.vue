<template>
  <common-layout>
    <div class="top">
      ...
      <div class="desc">Ant Design Is the most influential web design specification in West Lake</div>
    </div>
    <div class="login">
      <a-form @submit="onSubmit" :form="form">
        <a-tabs size="large" :tabBarStyle="{textAlign: 'center'}" style="padding: 0 2px;">
          <a-tab-pane tab="Account password login" key="1">
            ...
            <a-form-item>
              <a-input
                ...
                autocomplete="autocomplete"
                type="password"
                v-decorator="['password', {rules: [{ required: true, message: 'Please enter the password', whitespace: true}]}]"
              >
                <a-icon slot="prefix" type="lock" />
              </a-input>
            </a-form-item>
          </a-tab-pane>
          <a-tab-pane tab="Phone number login" key="2">
            <a-form-item>
            ...
            <a-form-item>
              <a-row :gutter="8" style="margin: 0 -4px">
                ...
                <a-col :span="8" style="padding-left: 4px">
                  <a-button style="width: 100%" class="captcha-button" size="large">get verification code</a-button>
                </a-col>
              </a-row>
            </a-form-item>
          </a-tab-pane>
